...
// import TX_Midland_Tax_Lien from '../../../../../categories/public_records/texas/midland/tax_lien_product';
...
//     beforeEach( () => {
//         product = new TX_Midland_Tax_Lien(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :texas :midland tax_lien', async () => {
