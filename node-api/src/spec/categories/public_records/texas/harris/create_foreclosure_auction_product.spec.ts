...
// import TX_Harris_Foreclosure_Auction from '../../../../../categories/public_records/texas/harris/foreclosure_auction_product';
...
//     beforeEach( () => {
//         product = new TX_Harris_Foreclosure_Auction(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :texas :harris foreclosure_auction', async () => {
