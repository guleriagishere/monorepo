...
// import TX_Dallas_Tax_Lien from '../../../../../categories/public_records/texas/dallas/tax_lien_product';
...
//     beforeEach( () => {
//         product = new TX_Dallas_Tax_Lien(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :texas :dallas tax_lien', async () => {
