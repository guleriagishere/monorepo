// import Tx_Denton_public_records from '../../../../../categories/public_records/consumers/property_appraisers/tx/denton/pa_consumer';
// import AbstractProduct from '../../../../../categories/public_records/consumers/property_appraisers/abstract_pa_consumer_updated';
// import CivilProducer from '../../../../../categories/public_records/producers/civil/tx/denton/civil_producer';
...
//     const publicRecordProducer = await db.models.PublicRecordProducer.findOne({ source: 'civil', county: 'denton', state: 'TX' });
//     producer = new CivilProducer(publicRecordProducer);
    
//     async function createOwner(): Promise<any> {
//         let productName = '/tx/denton/other-civil';
//         const prod = await db.models.Product.findOne({ name: productName }).exec();
//         const doc = {
//             "Full Name": 'SAMSON, THOMAS',
//             "First Name": 'THOMAS',
//             "Last Name": 'SAMSON',
//             "Middle Name": '',
//             "Name Suffix": '',
...
//         const doc = {
//             'Property State': 'TX',
//             'Property Address': '10220 FRANKLIN DR',
//             'Property Unit #': '',
//             'Property City': 'LITTLE ELM',
//             'Property Zip': '75068',
//             "fillingDate": '09/21/2020',
//             "productId": prod._id,
//             "County": "Denton",
...
// describe('=== TESTING PA SCRIPT - Denton, TX ===', () => {
...
//       beforeEach( async () => {
//           product = new Tx_Denton_public_records(state, county, practiceTypes, 'property-appraiser-consumer');
//       });

//       it('update :texas :denton new schema', async () => {
//           const resp = await product.startParsing();
//           const owner = await db.models.Owner.findOne({'Full Name': 'SAMSON, THOMAS', 'County': 'denton', 'Property State': 'TX'}).exec();
...
//       it('update :texas :denton new schema', async () => {
//           const resp = await product.startParsing();
//           const property = await db.models.Property.findOne({'Property Address': '10220 FRANKLIN DR', 'County': 'denton', 'Property State': 'TX'}).exec();
...
// // import TX_Denton_public_records from '../../../../../categories/public_records/consumers/property_appraisers/texas/denton/pa_consumer';
// // import AbstractProduct from '../../../../../categories/public_records/consumers/property_appraisers/abstract_pa_consumer_updated';
...
// //     describe('= search by name', () => {
// //       beforeEach( () => {
// //           product = new TX_Denton_public_records(state, county);
// //       });

// //       it('update :georgia :denton public_record_line_item', async () => {
// //           const resp = await product.startParsing();
