...
// import TX_Bexar_Tax_Lien from '../../../../../categories/public_records/texas/bexar/tax_lien_product';
...
//     beforeEach( () => {
//         product = new TX_Bexar_Tax_Lien(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :texas :bexar tax_lien', async () => {
