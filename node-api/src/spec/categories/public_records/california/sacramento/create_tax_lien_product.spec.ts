...
// import CA_Sacramento_Tax_Lien from '../../../../../categories/public_records/california/sacramento/tax_lien_product';
...
//     beforeEach( () => {
//         product = new CA_Sacramento_Tax_Lien(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :california :sacramento tax_lien', async () => {
