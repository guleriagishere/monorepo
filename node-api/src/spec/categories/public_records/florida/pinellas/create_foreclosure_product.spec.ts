...
// import FL_Pinellas_Foreclosure from '../../../../../categories/public_records/florida/pinellas/foreclosure_product';
...
//     beforeEach( () => {
//         product = new FL_Pinellas_Foreclosure(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :florida :pinellas foreclosure', async () => {
