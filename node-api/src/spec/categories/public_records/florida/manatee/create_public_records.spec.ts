// import Fl_Manatee_public_records from '../../../../../categories/public_records/consumers/property_appraisers/fl/manatee/pa_consumer';
// import AbstractProduct from '../../../../../categories/public_records/consumers/property_appraisers/abstract_pa_consumer_updated';
// import CivilProducer from '../../../../../categories/public_records/producers/civil/fl/manatee/civil_producer';
...
//     const publicRecordProducer = await db.models.PublicRecordProducer.findOne({ source: 'civil', county: 'manatee', state: 'FL' });
...
//         let productName = '/fl/manatee/auction';
//         const prod = await db.models.Product.findOne({ name: productName }).exec();
//         const doc = {
//             "Full Name": 'DOERR, STEPHAN M',
//             "First Name": 'STEPHAN',
//             "Last Name": 'DOERR',
//             "Middle Name": 'M',
//             "Name Suffix": '',
...
//         const doc = {
//             'Property State': 'FL',
//             'Property Address': '9310 69TH AVE',
//             'Property Unit #': '',
...
// describe('=== TESTing PA SCRIPT - MANATEE, FL ===', () => {
...
//       beforeEach( () => {
//           product = new Fl_Manatee_public_records(state, county, practiceTypes, 'property-appraiser-consumer');
//       });

//       it('update :florida :manatee public_record_line_item', async () => {
//           const resp = await product.startParsing();
          
//           const owner = await db.models.Owner.findOne({'Full Name': 'DOERR, STEPHAN M', 'County': 'manatee', 'Property State': 'FL'}).exec();
...
//       it('update :florida :manatee public_record_line_item', async () => {
//           const resp = await product.startParsing();
//           const property = await db.models.Property.findOne({'Property Address': '9310 69TH AVE', 'County': 'manatee', 'Property State': 'FL'}).exec();
...
// });
// /////// OLD HERE
// // import Fl_Manatee_public_records from '../../../../../categories/public_records/consumers/property_appraisers/florida/manatee/pa_consumer';
// // import AbstractProduct from '../../../../../categories/public_records/consumers/property_appraisers/abstract_pa_consumer_updated';
...
// //     describe('= search by name', () => {
// //       beforeEach( () => {
// //           product = new Fl_Manatee_public_records(state, county);
// //       });
