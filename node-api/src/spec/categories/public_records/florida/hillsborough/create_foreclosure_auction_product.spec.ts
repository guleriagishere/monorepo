...
// import FL_Hillsborough_Foreclosure_Auction from '../../../../../categories/public_records/florida/hillsborough/foreclosure_auction_product';
...
//     beforeEach( () => {
//         product = new FL_Hillsborough_Foreclosure_Auction(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :florida :hillsborough foreclosure_auction', async () => {
