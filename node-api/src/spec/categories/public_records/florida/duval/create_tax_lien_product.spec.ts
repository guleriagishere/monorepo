...
// import FL_Duval_Tax_Lien from '../../../../../categories/public_records/florida/duval/tax_lien_product';
...
//     beforeEach( () => {
//         product = new FL_Duval_Tax_Lien(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :florida :duval tax_lien', async () => {
