...
// import FL_Orange_Foreclosure_Auction from '../../../../../categories/public_records/florida/orange/foreclosure_auction_product';
...
//     beforeEach( () => {
//         product = new FL_Orange_Foreclosure_Auction(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :florida :orange foreclosure_auction', async () => {
