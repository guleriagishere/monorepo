...
// import FL_Broward_Foreclosure_Auction from '../../../../../categories/public_records/florida/broward/foreclosure_auction_product';
...
//     beforeEach( () => {
//         product = new FL_Broward_Foreclosure_Auction(fiveDaysAgo, currentDate);
//     });

//     it('creates :public_records :florida :broward foreclosure_auction', async () => {
