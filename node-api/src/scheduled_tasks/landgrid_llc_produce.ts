...
( async () => {
  ...
  const parseProperties = async (results: any[], product: IProduct, origin_name: string) => {
    ...
    for (let {properties} of results) {
      ...
      // check for duplicate
      let publicRecordLineItem: IPublicRecordAttributes = await db.models.PublicRecordLineItem.findOne({'Property Address': property.fields.address, 'Full Name': owner_full_name}).exec();
      ...
      try {
        if (publicRecordLineItem) {
          publicRecordLineItem['Property Address'] = line_item['Property Address'];
          publicRecordLineItem['Property Unit #'] = line_item['Property Unit #'];
          publicRecordLineItem['Property City'] = line_item['Property City'];
          publicRecordLineItem['Property State'] = line_item['Property State'];
          publicRecordLineItem['Property Zip'] = line_item['Property Zip'];
          publicRecordLineItem['County'] = line_item['County'];
          publicRecordLineItem['Owner Occupied'] = line_item['Owner Occupied'];
          publicRecordLineItem['First Name'] = line_item['First Name'];
          publicRecordLineItem['Last Name'] = line_item['Last Name'];
          publicRecordLineItem['Middle Name'] = line_item['Middle Name'];
          publicRecordLineItem['Name Suffix'] = line_item['Name Suffix'];
          publicRecordLineItem['Full Name'] = line_item['Full Name'];
          publicRecordLineItem['Mailing Care of Name'] = line_item['Mailing Care of Name'];
          publicRecordLineItem['Mailing Address'] = line_item['Mailing Address'];
          publicRecordLineItem['Mailing Unit #'] = line_item['Mailing Unit #'];
          publicRecordLineItem['Mailing City'] = line_item['Mailing City'];
          publicRecordLineItem['Mailing State'] = line_item['Mailing State'];
          publicRecordLineItem['Mailing Zip'] = line_item['Mailing Zip'];
          publicRecordLineItem['Property Type'] = line_item['Property Type'];
          publicRecordLineItem['Total Assessed Value'] = line_item['Total Assessed Value'];
          publicRecordLineItem['Last Sale Recording Date'] = line_item['Last Sale Recording Date'];
          publicRecordLineItem['Last Sale Amount'] = line_item['Last Sale Amount'];
          publicRecordLineItem['Est Value'] = line_item['Est Value'];
          publicRecordLineItem['Est Equity'] = line_item['Est Equity'];
          publicRecordLineItem['Effective Year Built'] = line_item['Effective Year Built'];
          publicRecordLineItem['owner_full_name'] = line_item['owner_full_name'];
          publicRecordLineItem['yearBuilt'] = line_item['yearBuilt'];
          publicRecordLineItem['vacancy'] = line_item['vacancy'];
          publicRecordLineItem['vacancyDate'] = line_item['vacancyDate'];
          publicRecordLineItem['parcel'] = line_item['parcel'];
          publicRecordLineItem['descbldg'] = line_item['descbldg'];
          publicRecordLineItem['listedPrice'] = line_item['listedPrice'];
          publicRecordLineItem['listedPriceType'] = line_item['listedPriceType'];
          publicRecordLineItem['practiceType'] = line_item['practiceType'];
          publicRecordLineItem['Total Open Loans'] = line_item['Total Open Loans'];
          publicRecordLineItem['Lien Amount'] = line_item['Lien Amount'];
          publicRecordLineItem['Est. Remaining balance of Open Loans'] = line_item['Est. Remaining balance of Open Loans'];
          publicRecordLineItem['Tax Lien Year'] = line_item['Tax Lien Year'];
          publicRecordLineItem['productId'] = line_item['productId'];
          publicRecordLineItem['propertyAppraiserProcessed'] = line_item['propertyAppraiserProcessed'];
          publicRecordLineItem['vacancyProcessed'] = line_item['vacancyProcessed'];
