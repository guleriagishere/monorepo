...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
      api_url: [
          'https://data.austintexas.gov/resource/5yf8-fm7j.json?registrationstatus=Active'
        ]
    };
