                            ...
                            await axios
                                ...
                                .then((fullRes: any) => {
                                    ...
                                    fullRes.data.d.parcelInfok__BackingField.forEach(async (element: any) => {
                                        ...
                                        // if ((this.searchBy === 'name' && element.ownerName1) || this.searchBy === 'address') {
                                        //     //document parsed 
                                        ...
                                        // if (element.ownerName2 && element.ownerName2.trim() != "") {
                                        //     if (this.searchBy === 'name') {
                                        //         const regexp = new RegExp(owner_name_regexp);
                                        //         if (regexp.exec(element.ownerName2.toUpperCase()) === null) {
                                        //             return;
                                        //         }
                                        //     }
                                        //     let newDoc = await this.cloneDocument(docToSave);

                                        //     let discriminateResult = discriminateAndRemove(element.ownerName2.replace('%',''));
                                        //     if (discriminateResult.type == 'person') {
                                        //         let separatedNamesArray = checkForMultipleNamesAndNormalize(discriminateResult.name);
                                        //         for (let separatedNameObj of separatedNamesArray) {
                                        ...
                                        //         }
                                        //     } else {
                                        //         newDoc["Full Name"] = element.ownerName2;
                                        //     }
                                        //     console.log(newDoc);
