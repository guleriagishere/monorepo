...
//                 const isResultList = await this.checkExistElement(page, 'select[name="search-results_length"]');
//                 if (isResultList) {
//                   await page.select('select[name="search-results_length"]', "100");
...
//                     await page.goto(URL_DETAIL, {waitUntil: 'load'});
