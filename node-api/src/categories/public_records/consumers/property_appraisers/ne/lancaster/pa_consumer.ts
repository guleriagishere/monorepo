...
//                 ]);
//                 await page.waitForSelector('div[id$="_ModuleContent"] > div:first-child > div:nth-child(2) > div:nth-child(3) > table > tbody > tr:first-child > td:first-child');


//                 // // check result
//                 const id_selector_1 = 'div[id$="_ModuleContent"] > div:first-child > div:nth-child(2) > div:nth-child(3) > table > tbody > tr:first-child > td:first-child';
//                 const id_selector_2 = 'div[id$="_ModuleContent"] > div:first-child > div:nth-child(2) > div:nth-child(3) > table > tbody > tr:first-child > td:nth-child(3)';
//                 const id1 = await this.getElementTextContent(page, id_selector_1);
//                 const id2 = await this.getElementTextContent(page, id_selector_2);
//                 if (id1 && id2) {
//                   await page.goto(`http://orion.lancaster.ne.gov/Property-Detail/PropertyQuickRefID/${id1}/PartyQuickRefID/${id2}`, {waitUntil: 'load'});
...
//       // name
//       const owner_names = [];
//       const onwer_name_selector = 'td[id$="OwnerName"]';
//       const owner_name = await this.getElementTextContent(page, onwer_name_selector);
...
//       // mailing address
//       const mailing_address_selector  = 'td[id$="MailingAddress"]';
...
//       // property type
//       const property_type_selector = 'div[id$="divResCamaInfo"] > ul > li:first-child > table > tbody > tr:nth-child(2) > td:nth-child(3)';
//       const property_type = await this.getElementTextContent(page, property_type_selector);

//       // sales info
//       const last_sale_date_selector = 'table[id$="tblSalesHistoryData"] > tbody > tr:nth-child(2) > td:first-child';
//       const last_sale_amount_selector = 'table[id$="tblSalesHistoryData"] > tbody > tr:nth-child(2) > td:nth-child(5)';
...
//       const total_assessed_selector = 'table[id$="tblValueHistoryDataRP"] > tbody > tr:nth-child(2) > td:nth-child(4)';
