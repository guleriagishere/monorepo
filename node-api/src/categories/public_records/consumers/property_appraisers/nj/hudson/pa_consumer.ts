...
//     urls = {
//         propertyAppraiserPage: 'http://www.hudsoncountynj.org/search-tax-records/'
//     }

//     xpaths = {
//         isPAloaded: '//select[@name="district"]'
//     }
...
//                 // choose city
//                 for (const optdetail of option_details) {
//                   if (address.parsed.city && optdetail.city == address.parsed.city.trim().toUpperCase()) {
//                     await page.select('select[name="district"]', optdetail.value);
//                     break;
//                   }
//                 }
//                 // input address
//                 const inputHandle = await page.$x('//input[@name="p_loc"]');
...
//                 const moreinfo = await page.$('table > tbody > tr > td:first-child > a');
//                 if (moreinfo) {
...
//       // name
//       const full_name_selector = 'body > table:nth-of-type(1) > tbody > tr:first-child > td:nth-child(6) > font';
...
//       // mailing address
//       const street_selector = 'body > table:nth-of-type(1) > tbody > tr:nth-child(2) > td:nth-child(6) > font';
//       const city_selector = 'body > table:nth-of-type(1) > tbody > tr:nth-child(3) > td:nth-child(6) > font';
//       const street = await this.getElementTextContent(page, street_selector);
//       const city_state = await this.getElementTextContent(page, city_selector);
//       const mailing_address = street + ', ' + city_state;
...
//       // property type
//       const property_type = 'N/A';

//       // sales info
//       const last_sale_recording_date_selector = 'body > table:nth-of-type(1) > tbody > tr:nth-child(11) > td:nth-child(2) > font';
//       const last_sale_amount_selector = 'body > table:nth-of-type(1) > tbody > tr:nth-child(11) > td:nth-child(6) > font:first-child';
...
//       const total_assessed_value_selector = 'body > table:nth-of-type(3) > tbody > tr:nth-child(3) > td:nth-child(5) > font';
