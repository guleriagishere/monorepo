...
//     urls = {
//         propertyAppraiserPage: 'https://secure.tennesseetrustee.org/?entity=hickman&state=TN'
//     }

//     xpaths = {
//         isPAloaded: '//input[@id="property_address"]'
//     }
...
//               try {                
//                 // input address
//                 const inputAddrHandle = await page.$x('//input[@id="property_address"]');
...
//                 // check result
//                 const view_button_handle = await page.$('table#example > tbody > tr:first-child > td:nth-child(13) > img');
//                 if (view_button_handle) {
//                   await view_button_handle.click();
//                   await page.waitForSelector('#saleHist');
...
//        // name
//       const owner_names = [];
//       const name_selctor = 'div#main > div:nth-child(2) > div:first-child > table > tbody > tr:nth-child(11) > td:nth-child(2)';
//       const owner_name = await this.getElementTextContent(page, name_selctor);
//       const owner_name_arr = owner_name.split('Etux');
...
//       // mailing address
//       const address_selector = 'div#main > div:nth-child(2) > div:first-child > table > tbody > tr:nth-child(13) > td:nth-child(2)';
//       const city_selector = 'div#main > div:nth-child(2) > div:first-child > table > tbody > tr:nth-child(14) > td';
//       const zip_selector = 'div#main > div:nth-child(2) > div:first-child > table > tbody > tr:nth-child(15) > td';
//       const owner_address = await this.getElementTextContent(page, address_selector);
//       const owner_city = await this.getElementTextContent(page, city_selector);
//       const owner_zip = await this.getElementTextContent(page, zip_selector);
//       const mailing_address = owner_address.trim() + ', ' + owner_city.trim() + ' ' + owner_zip.trim();
...
//       // property type
//       const property_type_selctor = 'div#main > div:nth-child(2) > div:nth-child(2) > table > tbody > tr:nth-child(10) > td:nth-child(2)';
//       const property_type = await this.getElementTextContent(page, property_type_selctor);

//       // sales info
//       const last_sale_recording_date_selector = 'table#saleHist > tbody > tr:first-child > td:first-child';
//       const last_sale_amount_selctor = 'table#saleHist > tbody > tr:first-child > td:nth-child(2)';
//       const last_sale_recording_date = await this.getElementTextContent(page, last_sale_recording_date_selector);
//       const last_sale_amount = await this.getElementTextContent(page, last_sale_amount_selctor);
      
//       // assessed value and est. value
//       const total_assessed_value_selector = 'div#main > div:nth-child(2) > div:nth-child(2) > table > tbody > tr:nth-child(8) > td:nth-child(2)';
//       const est_value_selector = 'div#main > div:nth-child(2) > div:nth-child(2) > table > tbody > tr:nth-child(7) > td:nth-child(2)';
