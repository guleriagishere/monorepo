    ...
    async parseAndSave(docsToParse: IOwnerProductProperty[]): Promise<boolean> {
        ...
        for (let document of docsToParse) {
            ...
            for (const datalink of detalinks) {
                ...
                //     let newDataFromPropertyAppraisers = {...dataFromPropertyAppraisers, 
                //         'Full Name': owner_fullname_2 ? owner_fullname_2.trim() : '',
                //         'First Name': owner_first_2 ? owner_first_2 : '',
                //         'Last Name': owner_last_2 ? owner_last_2 : '',
                //         'Middle Name': owner_middle_2 ? owner_middle_2 : '',
                //         'Name Suffix': owner_suffix_2 ? owner_suffix_2 : ''}
                //     await this.saveToOwnerProductPropertyV2(newDocument, newDataFromPropertyAppraisers );
