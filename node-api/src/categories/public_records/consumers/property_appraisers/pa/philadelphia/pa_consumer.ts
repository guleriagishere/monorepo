...
//                                 document["Property Type"] = res.category_code_description;
//                             }
//                         } catch (error) {
...
//                                     document["Mailing Address"] = res.location;
...
//                                         document["Mailing City"] = res.mailing_city_state.split(' ')[0];


//                                     //mailing state
//                                     if (res.mailing_city_state.split(' ')[1])
//                                         document["Mailing State"] = res.mailing_city_state.split(' ')[1];
...
//                                     document["Mailing Zip"] = res.mailing_zip;
//                                 }
...
//                                 document["Last Sale Recording Date"] = res.sale_date;
//                             }
//                         } catch (error) {
...
//                             if (res.sale_price) {
//                                 document["Last Sale Amount"] = res.sale_price;
//                             }
//                         } catch (error) {
...
//                             if (res.market_value) {
//                                 document["Est Value"] = res.market_value;
//                             }
