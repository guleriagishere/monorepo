...
//       property_address = addressService.normalizeAddress(property_address.replace(/\s+/gm, ' ').trim());
...
//       const mailing_address = addressService.normalizeAddress(street.replace(/\s+/gs, ' ').trim());
//       const mailing_address_parsed = parser.parseLocation(mailing_address + ' ' + city);
