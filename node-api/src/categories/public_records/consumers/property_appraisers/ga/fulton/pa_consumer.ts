...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    async getData(page: puppeteer.Page, doc: any) {
        ...
        try{
          await page.waitForXPath('//*[text()="Effective Year Built:"]/following-sibling::td[1]' , {timeout : 1000});
          const effectiveYearBuiltXpath = await page.$x('//*[text()="Effective Year Built:"]/following-sibling::td[1]');
