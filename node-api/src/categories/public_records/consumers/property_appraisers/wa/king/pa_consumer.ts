...
//                 await inputCtHandle[0].type(address.city, {delay: 150});
//                 await inputZipHandle[0].type(address.zip, {delay: 150});

//                 await Promise.all([
//                   inputZipHandle[0].type(String.fromCharCode(13), {delay: 150}),
