...
//     xpaths = {
//         isPAloaded: '//input[@id="propertySearchOptions_streetNumber"]'
//     }
...
//                 await page.reload();
//               }
//               await page.select('select#propertySearchOptions_searchType', 'owner');
//               await page.select('select#propertySearchOptions_searchType', 'address');
          
//               try {
//                 // input street number
//                 const inputNumHandle = await page.$('input#propertySearchOptions_streetNumber');
//                 if (address['parsed']['number'] && inputNumHandle) {
//                   await inputNumHandle.type(address['parsed']['number'], {delay: 100});
//                 }
//                 // // input address
//                 const inputAddrHandle = await page.$('input#propertySearchOptions_streetName');
//                 if (inputAddrHandle)
...
//                 // // check result
//                 const link_handle_selector = 'table#propertySearchResults_resultsTable > tbody > tr:nth-child(2) > td:nth-child(10) > a';
...
//       // name
//       const owner_names = [];
//       const owner_name_selector = '#propertyDetails > table > tbody > tr:nth-child(16) > td:nth-child(2)';
...
//       // mailing address
//       const mailing_address_selector = '#propertyDetails > table > tbody > tr:nth-child(17) > td:nth-child(2)';
...
//       // property type
//       const property_type_selector = '#propertyDetails > table > tbody > tr:nth-child(4) > td:nth-child(2)';
//       const property_type = await this.getElementTextContent(page, property_type_selector);

//       // sales info
//       const last_sale_date_selector = '#deedHistoryDetails > table > tbody > tr:nth-child(2) > td:nth-child(2)';
//       const last_sale_amount_selector = '#deedHistoryDetails > table > tbody > tr:nth-child(2) > td:nth-child(9)';
...
//       const total_assessed_selector = '#rollHistoryDetails > table > tbody > tr:nth-child(3) > td:nth-child(5)';
