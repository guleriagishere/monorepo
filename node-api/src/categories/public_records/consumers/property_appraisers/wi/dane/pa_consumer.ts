...
//             const search_addr = address['street_full'];
//             let retry_count = 0;
//             while (true){
//               if (retry_count > 15){
...
//                 // input address
//                 const inputAddrHandle = await page.$x('//input[@id="inputQuickSearch"]');
//                 await inputAddrHandle[0].type(search_addr);
//                 await Promise.all([
...
//                     const moreinfo = await page.$('table#parcelTable > tbody > tr > td:first-child > strong > a');
//                     if (moreinfo) {
...
//       // name
//       let owner_name_handles = await page.$x('//div[@id="parcelSummary"]/table/tbody/tr[3]/td[2]/ul/li');
//       let owner_names = [];
//       for (let owner_name_handle of owner_name_handles) {
//         let owner_name = await page.evaluate(el => el.textContent, owner_name_handle);
...
//       // mailing address
//       const mailing_address_selector = 'div#parcelSummary > table > tbody > tr:nth-child(5) > td:nth-child(2) > ul';
...
//       // property type
//       const property_type_selector = 'div#assessmentSummary > table > tbody > tr:first-child > td:nth-child(2)';
...
//       // sales info
//       const last_sale_recording_date = 'N/A';
//       const last_sale_amount = 'N/A';
      
//       // assessed value and est. value
//       const total_assessed_value_selector = 'div.taxDetailTable:first-of-type > table > tbody > tr:nth-child(2) > td:nth-child(3)';
//       const est_value_selector = 'div#assessmentSummary > table > tbody > tr:nth-child(5) > td:nth-child(2)';
